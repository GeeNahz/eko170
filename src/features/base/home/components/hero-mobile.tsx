...
export function HeroMobile() {
  ...
  return (
    <div className="relative min-h-[760px] overflow-hidden bg-[#05080d]">
      <SplashLoader />
      ...
      <div className="relative z-10 flex flex-col px-6">
        <div className="pt-8">
          ...
          <div className="mb-6 flex flex-wrap items-center gap-4">
            <p className="font-heading m-0 text-[64px] leading-[0.85] font-black text-white italic">
              EKO<span className="text-brand-green">170</span>
            </p>
            <p className="font-sans text-2xl leading-tight font-extralight text-white italic uppercase">
              Lagos&apos; Biggest
              <br />
              <span className="text-yellow-400">Cycling Challenge</span>
            </p>
          </div>
          <p className="mb-8 font-sans text-base leading-relaxed text-white/72">
            Experience the Movement. Made in Lagos. 170 kilometres of closed
            roads from Eko Atlantic City through Victoria Island, Lekki, and
            all the way to Epe.
          </p>
