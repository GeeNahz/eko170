...
export function RegisterCta() {
  return (
    <div className="mx-3 mt-4 overflow-hidden rounded-[22px] bg-linear-120 from-brand-teal via-brand-green to-brand-yellow px-5 pt-11 pb-12 text-center sm:mx-4 sm:px-10 sm:py-20">
